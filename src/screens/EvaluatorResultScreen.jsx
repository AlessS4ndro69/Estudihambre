...
const EvaluatorResultScreen = () => {
    ...
    return (
        <SafeAreaView style = {tw`bg-white h-full justify-center items-center pt-5`}>
    ...
    />*/}
            <View style = {tw `items-center`}>
                ...
                {toShowSolution && <Answer message="Solución" onClose={closeSolution} idAnswer={data[questionNumber].id}/>}
...
export default EvaluatorResultScreen;